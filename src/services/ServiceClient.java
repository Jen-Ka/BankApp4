...
//вар.1 хранить номерки в очереди с привязкой к клиенту (List/Array с доп.функционалом для удаления отработанного)

//вар. 2 хранить клиентов (аналог базы клиентов) - можно использовать List, но с доп.обработкой для исключения дублей

//вар. 3 использовать комбинированный способ через доп.класс
